package javaExercise.part15.ex41;//: generics/Fill2.java
// Using adapters to simulate latent typing.
// {main: Fill2Test}

import java.util.*;

import javaExercise.part15.coffee.Coffee;
import javaExercise.part15.coffee.Latte;
import javaExercise.part15.coffee.Mocha;
import javaExercise.part15.ex40.SimpleQueue;
import javaExercise.part15.ex40.pets.Cat;
import javaExercise.part15.ex40.pets.Dog;
...
class Fill2Test {
    public static void main(String[] args) {
        ...
        Fill2.fill(new AddableCollectionAdapter<Pet>(pets), Pet.class, 3);
        // Helper method captures the type:
        Fill2.fill(Adapter.collectionAdapter(pets), Cat.class, 2);
        for (Pet c : pets)
            print(c);
        print("----------------------");
