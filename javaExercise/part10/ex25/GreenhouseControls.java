package part10.ex25;//: innerclasses/GreenhouseControls.java
...
import part10.ex25.controller.Controller;
import part10.ex25.controller.Event;

class SuperGreenhouseControls extends GreenhouseControls {
...
public class GreenhouseControls extends Controller {
    ...
    public class OpenFan extends Event {
        ...
        public String toString() {
            return "Greenhouse fan is open";
        }
    }

    public class CloseFan extends Event {
        public CloseFan(long delayTime) {
            super(delayTime);
        }
        ...
        public String toString() {
            return "Greenhouse fan is close";
        }
    }
} ///:~
